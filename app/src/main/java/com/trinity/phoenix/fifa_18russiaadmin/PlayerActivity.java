...
public class PlayerActivity extends AppCompatActivity {
    ...
    private void image(){
        ...
        if(filePath != null)
        {
            ...
            Toast.makeText(PlayerActivity.this,"name "+name,Toast.LENGTH_LONG).show();
            ...
            ref.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(PlayerActivity.this, "Uploaded", Toast.LENGTH_SHORT).show();
                            teamappData.setUrl(String.valueOf(taskSnapshot.getDownloadUrl()));
                            FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
                            DatabaseReference databaseReference = firebaseDatabase.getReference().child(name).child("playerList");
                            databaseReference.push().setValue(teamappData).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    Toast.makeText(PlayerActivity.this, "Data Added", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(PlayerActivity.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
